...
class Testing123:
    ...
    def testcase4():
        ...
        driver.get_screenshot_as_file("CKairsChrome0903.png")
        ...
        driver.find_element(By.ID, "emailId").send_keys("email.contest")
        driver.get_screenshot_as_file("CKairsChrome09032.png")
        driver.close()
