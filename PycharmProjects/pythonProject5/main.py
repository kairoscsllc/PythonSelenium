...
class Testing123:
    def testcase():
        ...
        driver.get_screenshot_as_file("SAFeDEVOPSCNNScreenshot.png")
        driver.find_element(By.XPATH, "/html/body/div[5]/div/div/header/div/div[1]/div/div[2]/nav/ul/li[9]/a").click()
        time.sleep(20)
        driver.get_screenshot_as_file("SAFeDEVOPSCNNScreenShot2.png")
        driver.close()
    ...
    def testcase2():
        ...
        time.sleep(20)
        driver.get_screenshot_as_file("SAFeDEVOPSFirefox1.png")
        driver.quit()
    ...
    def testcase3():
        ...
        time.sleep(10)
        driver.get_screenshot_as_file("SAFeDEVOPScreenSafari1.png")
        driver.quit()
    ...
    #     time.sleep(10)
    #     driver.find_element(By.ID, "yourNameId").send_keys("test")
    #     driver.find_element(By.ID, "emailId").send_keys("email.comtest")
    #     driver.get_screenshot_as_file("FromScreen.png")
    #     driver.close()
